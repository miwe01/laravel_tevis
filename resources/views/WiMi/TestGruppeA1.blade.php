...
<table border="2">
    ...
    <tr>
        ...
        <th>Max</th>
        <th>Mustermann</th>
        <th><textarea style="resize: none">noch nachzeigen</textarea></th>
        <th><input type="checkbox" id="scales" name="scales"checked></th>
        <th><input type="checkbox" id="scales" name="scales"checked></th>
        <th><input type="checkbox" id="scales" name="scales"checked></th>
...
<br>
<br>
<button type="button">ändern</button> </th>
