...
//            ->get();
    ...
    public function testat(Request $request)
    {
        ...
        return view('Professor.testat',['testat'=>$testat, 'gruppenname' => $request->Gruppenname, 'Gruppenummer'=>$request->Gruppenummer,  'modulname' => $request->Modulname,'title'=>'testat']);
    ...
    public function kurs(Request $request){
        ...
        return view('Professor.kurs', ['title' => 'Modul','Modulnummer' => $request->Modulnummer,'jahr' => $request->Jahr,'gruppennummer' => $request->Gruppenummer,
            'module'=>$module, 'gruppen' => $gruppen,'gruppe'=>$gruppe,'TNanzahl'=>$TNanzahl]);
    }

    public function newGroup(Request $request){

        return view('Professor.new_group',['title' => 'Neue Gruppe']);
    }
